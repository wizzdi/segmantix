...
public record SecurityPermissionEntry<T extends ISecurityEntity>(T entity,
    ...
    public static <T extends ISecurityEntity,E extends ISecurity> SecurityPermissionEntry<T> of(T t, List<E> links, Map<String, List<IInstanceGroupLink>> instanceGroupLinkes) {
