...
private SecurityUserService securityUserService;
    ...
    public void testForUser() {
        ...
        userToBaseclassService.createUserToBaseclass(new UserToBaseclassCreate().setUser(testUser).setAccess(Access.allow).setSecuredId(forUser.getId()).setClazz(TEST_ENTITY_CLAZZ).setOperation(securityOperationService.getAllOperations()),null);
        List<TestEntity> testEntities = testEntityService.listAllTestEntities(new TestEntityFilter(), testUserSecurityContext);
    ...
    public void testForRole() {
        ...
        roleToBaseclassService.createRoleToBaseclass(new RoleToBaseclassCreate().setRole(testRole).setAccess(Access.allow).setSecuredId(forRole.getId()).setClazz(TEST_ENTITY_CLAZZ).setOperation(securityOperationService.getAllOperations()),null);
        List<TestEntity> testEntities = testEntityService.listAllTestEntities(new TestEntityFilter(), testUserSecurityContext);
    ...
    public void testForTenant() {
        ...
        tenantToBaseclassService.createTenantToBaseclass(new TenantToBaseclassCreate().setTenant(testTenant).setAccess(Access.allow).setSecuredId(forTenant.getId()).setClazz(TEST_ENTITY_CLAZZ).setOperation(securityOperationService.getAllOperations()),null);
        List<TestEntity> testEntities = testEntityService.listAllTestEntities(new TestEntityFilter(), testUserSecurityContext);
    ...
    public void testPermissionGroupForUser() {
        ...
        userToBaseclassService.createUserToBaseclass(new UserToBaseclassCreate().setUser(testUser).setAccess(Access.allow).setPermissionGroup(forUserGroup).setOperation(securityOperationService.getAllOperations()),null);
        List<TestEntity> testEntities = testEntityService.listAllTestEntities(new TestEntityFilter(), testUserSecurityContext);
        Assertions.assertTrue(testEntities.stream().anyMatch(f->f.getId().equals(forUser.getId())));
        Assertions.assertTrue(testEntities.stream().noneMatch(f-> othersInOtherTenantIds.contains(f.getId())));
        Assertions.assertTrue(testEntities.stream().noneMatch(f->othersInTenantIds.contains(f.getId())));
    ...
    public void testPermissionGroupForRole() {
        ...
        roleToBaseclassService.createRoleToBaseclass(new RoleToBaseclassCreate().setRole(testRole).setAccess(Access.allow).setPermissionGroup(forRoleGroup).setOperation(securityOperationService.getAllOperations()),null);
        List<TestEntity> testEntities = testEntityService.listAllTestEntities(new TestEntityFilter(), testUserSecurityContext);
        Assertions.assertTrue(testEntities.stream().anyMatch(f->f.getId().equals(forRole.getId())));
        Assertions.assertTrue(testEntities.stream().noneMatch(f-> othersInOtherTenantIds.contains(f.getId())));
        Assertions.assertTrue(testEntities.stream().noneMatch(f->othersInTenantIds.contains(f.getId())));
    ...
    public void testPermissionGroupForTenant() {
        ...
        tenantToBaseclassService.createTenantToBaseclass(new TenantToBaseclassCreate().setTenant(testTenant).setAccess(Access.allow).setPermissionGroup(forTenantGroup).setOperation(securityOperationService.getAllOperations()),null);
        List<TestEntity> testEntities = testEntityService.listAllTestEntities(new TestEntityFilter(), testUserSecurityContext);
        Assertions.assertTrue(testEntities.stream().anyMatch(f->f.getId().equals(forTenant.getId())));
        Assertions.assertTrue(testEntities.stream().noneMatch(f-> othersInOtherTenantIds.contains(f.getId())));
        Assertions.assertTrue(testEntities.stream().noneMatch(f->othersInTenantIds.contains(f.getId())));
    ...
    public void testAccessDenyForUser() {
        ...
        // grant it access for clazz
        TestEntity toDeny = testEntityService.findByIdOrNull(othersInTenantIds.stream().findFirst().orElseThrow(() -> new RuntimeException("no test entity found")));
