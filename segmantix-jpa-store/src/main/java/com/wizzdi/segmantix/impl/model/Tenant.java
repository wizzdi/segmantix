...
@Entity
public class Tenant extends SecurityEntity implements ITenant {
	...
	@OneToMany(targetEntity = TenantSecurity.class,mappedBy="tenant")
	private List<TenantSecurity> tenantSecurityes =new ArrayList<>();
